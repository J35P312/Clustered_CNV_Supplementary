...
for line in open(sys.argv[1]):
    content=line.split("\t")
    if not content[0] in counter:
        counter[content[0]] =0
    counter[content[0]] +=1

    sample=content[0]+"#"+str( counter[content[0]])
...
print "junction\t#avg_repeat_distance\trepeats_within_1kb\tbps\tavg_MH_len\tMH_jnct\tavg_insert_len\tinsert_jnct\ttotal_jnct\tsnps_within_1kb"
for sample in data:
    ...
    if nINS:
        ...
        avgINS=0
    print "{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}".format(sample,AVG_RD,RDH,bps,avgMH,nMH,avgINS,nINS,counter[sample.split("#")[0]],data[sample]["snps"])
